            ...
            <div class="bx--col-lg-8">
                <div class="bx--tile">
                    <div style="display: flex; align-items: center; gap: 2rem;">
                        ...
                        <div>
                            <h1 class="bx--type-productive-heading-05">Yasmin Mohammad Ali</h1>
                    ...
                    <div style="margin-top: 2rem;">
                        ...
                        <p class="bx--type-body-long-02">
                            I am a second year student of YENEPOYA INSTITUTE OF ARTS, SCIENCE, COMMERCE AND MANAGEMENT.
                            Currently doing Bachelores degree of Business Administration with Entreprenureship and Business Analytics.                        </p>
                    </div>
